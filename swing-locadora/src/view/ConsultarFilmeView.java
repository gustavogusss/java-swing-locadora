...
/**
 * Classe responsável por criar interface gráfica da consulta de filmes
 * 
...
public class ConsultarFilmeView {
	...
	private String colunas[] = {"Código", "Nome", "Valor", "Disponível", "Promoção", "Valor Promoção"};
	...
	public void carregarTabela() {
		...
		for (Filme filme : new FilmeController().getFilmes()) {
			...
			modelo.addRow(new String[] { filme.getCodigo() + "", filme.getNome(), filme.getValor() + "",
					(filme.isDisponivel()) ? "Sim" : "Não", (filme.isPromocao()) ? "Sim" : "Não", filme.getValorPromocao() + ""});
		}
