...
/**
 * Classe responsável por criar interface gráfica de consulta de vendedor
 * 
...
public class ConsultarVendedorView {
	...
	private String colunas[] = { "Nome", "Área de Vendas", "Cidade", "Estado", "Sexo", "Idade", "Salário" };
	...
	/*
	 * Método para carregar a tabela com os vendedores cadastrados
	 */
